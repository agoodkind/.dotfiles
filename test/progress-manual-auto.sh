...
check "Saw [-] Failing task, then [✗] Failing task (red) with output visible below?"
fi
...
check "Saw dimmed output lines, then [✗] Compile with errors (red), error output visible below?"
fi
