...
description: Run the /draft-slack-reply command workflow from the dotfiles agent command library when the user explicitly asks for /draft-slack-reply or mentions this command by name.
---
