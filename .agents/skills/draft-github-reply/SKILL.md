---
name: draft-github-reply
description: Run the /draft-github-reply command workflow from the dotfiles agent command library when the user explicitly asks for /draft-github-reply or mentions this command by name.
---
