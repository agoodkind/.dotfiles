---
name: push
description: Run the /push command workflow from the dotfiles agent command library when the user explicitly asks for /push or mentions this command by name.
---
