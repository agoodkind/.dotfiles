...
sudo apt-get install -y \
	arping ack ack-grep ansible aria2 bat bash coreutils curl eza fail2ban \
	...
	speedtest-cli smartmontools sshuttle thefuck tree vim watch wget wireguard zsh yq
