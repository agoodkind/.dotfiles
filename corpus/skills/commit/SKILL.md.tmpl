---
name: commit
description: Run the /commit command workflow from the dotfiles agent command library when the user explicitly asks for /commit or mentions this command by name.
---
