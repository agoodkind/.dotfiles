...
description: Run the /commit-and-push command workflow from the dotfiles agent command library when the user explicitly asks for /commit-and-push or mentions this command by name.
---
