---
name: update-main
description: Run the /update-main command workflow from the dotfiles agent command library when the user explicitly asks for /update-main or mentions this command by name.
---
