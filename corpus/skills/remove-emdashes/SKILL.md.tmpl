---
name: remove-emdashes
description: Run the /remove-emdashes command workflow from the dotfiles agent command library when the user explicitly asks for /remove-emdashes or mentions this command by name.
---
