---
name: run
description: Run the /run command workflow from the dotfiles agent command library when the user explicitly asks for /run or mentions this command by name.
---
